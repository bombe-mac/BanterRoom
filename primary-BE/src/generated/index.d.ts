...
export namespace Prisma {
  ...
  */
  ...
  export type RoomOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "ownerId" | "createdAt" | "updatedAt", ExtArgs["result"]["room"]>
  ...
  export type RoomMemberOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId" | "roomId" | "joinedAt", ExtArgs["result"]["roomMember"]>
  ...
  export interface RoomMemberDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const roomMemberWithUserIdOnly = await prisma.roomMember.findMany({ select: { userId: true } })
     * 
     */
     ...
     * const roomMemberWithUserIdOnly = await prisma.roomMember.createManyAndReturn({
     *   select: { userId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const roomMemberWithUserIdOnly = await prisma.roomMember.updateManyAndReturn({
     *   select: { userId: true },
     *   where: {
     *     // ... provide filter here
     *   },
